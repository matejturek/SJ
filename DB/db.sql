...
--
-- Hostiteľ: 127.0.0.1
-- Čas generovania: St 29.Nov 2023, 17:32
...
-- Databáza: `xbeat`
--
CREATE DATABASE IF NOT EXISTS `xbeat` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `xbeat`;
...
(1, 'admin', 'admin', 'admin'),
(3, 'admin2', '', 'admin2@gmail.com'),
(5, 'admin3', 'admin', 'admin3@gmail.com'),
(7, 'admin5', 'admina', 'admin5@gmail.com');
