...
const ProductDetails = () => {
    ...
    const product = productsData.find(item => item.id === prodId.toString());
    ...
    useEffect(() => {
        if (product) {
            setPreviewImg(JSON.parse(product.images)[0]);
            handleActive(0);
        }
    ...
    const handlePreviewImg = (i) => {
        setPreviewImg(JSON.parse(images)[0]);
        handleActive(i);
    };
